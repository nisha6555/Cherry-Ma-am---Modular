...
export type PodcastAudioEngineMode = "dual_browser_tts" | "neural_cloud_audio" | "offline_cached";
...
export interface ConceptInfographicData {
  ...
  observationSection?: {
    formulaLatex?: string;
    conditions?: Array<{ rawName?: string; conditionLatex?: string; outcome?: string }>;
    keyInsights?: string[];
  };
  vectorFormSection?: {
